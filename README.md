...
<p align="center">
  <img src="docs/architecture.svg" width="440" alt="Uncertainty-aware routing: a shared 8-bit trunk feeds a Bayesian router whose epistemic uncertainty reweights routing toward higher-precision experts.">
</p>

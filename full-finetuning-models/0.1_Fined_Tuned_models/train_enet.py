...
def get_args_parser():
    ...
    parser.add_argument('--experiment_name', type=str, default="BS_Pytorch_EPOCHS")
...
def train_model(train_loader, val_loader, num_classes, experiment_name, early_stopping_patience, epochs):
    ...
    for epoch in range(epochs):
        ...
        val_loss, val_accuracy, val_f1, _, _ = validate_model(model, criterion, val_loader)
...
def test_model(model, test_loader):
    criterion = nn.CrossEntropyLoss()
    test_loss, test_accuracy, test_f1, all_labels, all_preds = validate_model(model, criterion, test_loader)

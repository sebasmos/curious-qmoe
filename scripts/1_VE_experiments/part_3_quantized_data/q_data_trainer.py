...
def main(args):
    ...
    for seed in range(args.total_num_seed):
        ...
        train_dataset = QuantizedEmbeddingDataset(train_csv, train=True, save_embeddings=False)
        val_dataset = QuantizedEmbeddingDataset(val_csv, train=False, save_embeddings=False)
